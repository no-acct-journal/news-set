...
async def check_favorite(
    ...
    return success_response(message="Favorite status retrieved successfully", data=FavoriteCheckResponse(isFavorite=is_favorited))
...
async def add_favorite(
    ...
    return success_response(message="Favorite added successfully", data=result)
...
async def get_favorite_list(
    ...
    return success_response(message="Favorite list retrieved successfully", data=data)
...
async def clear_favorite(
    ...
    return success_response(message=f"Cleared {count} favorite entries")
